...
type UploadAttachmentRespBody struct {
	Code int                `json:"code"`
	Data interface{}        `json:"data"`
	Body AttachmentRespBody `json:"body"`
}

type AttachmentRespBody struct {
...
func NewUploadAttachmentApi(params UploadAttachmentParams) (apiConf common.ApiConf) {
	return common.ApiConf{
		Url:    Prefix + "/uploader/upload",
...
type GetUploadTokenRespBody struct {
...
func NewGetUploadTokenApi(params GetTokenParams) common.ApiConf {
	extra := map[string]string{
		"Content-Type": "application/json",
	}
	return common.ApiConf{
		Url:    Prefix + "/uploader/token",
		Method: http.MethodPost,
		ReqParams: common.ApiRequestParams{
